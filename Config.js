...
const MLB_APPS_SCRIPT_BUILD = 54;
...
function buildConfigTab() {
  ...
  row_('GS_MIN_HR_PA', '40', '🎴 Game Cards: (legacy) min season PA guard for HR context. HR icon now gates on HR-tab rank, see GS_HR_ICON_TOP_N.');
