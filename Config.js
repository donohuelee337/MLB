...
function buildConfigTab() {
  ...
  row_('ANCHOR_WEIGHT_BATTER_HITS', '0.35', '0..1 anchor for expected hits λ on ⚡ Sim_Batter_Hits');
  row_('ANCHOR_WEIGHT_BATTER_TB', '0.35', '0..1 anchor for expected TB λ on ⚡ Sim_Batter_TB');
