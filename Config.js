...
const MLB_APPS_SCRIPT_BUILD = 23;
...
function buildConfigTab() {
  ...
  row_('STREAK_MIN_PA', '50', 'Min season PA for 🔥 Streak_Picks: low_sample_pa=LOW below this; batters under the floor cannot be is_pick. 0 = show PA/AB columns only (no pick gate).');
  row_('HITS_V3_MIN_PA', '50', 'Min season PA on 🧪 Batter_Hits_Card_v3-contact: low_sample_pa=LOW + flags low_pa below this. 0 = alert columns only (no flag).');
...
function validateMlbPipelineConfig_(cfg) {
  ...
  warnRange('STREAK_MIN_PA', c['STREAK_MIN_PA'], 0, 200);
  warnRange('HITS_V3_MIN_PA', c['HITS_V3_MIN_PA'], 0, 200);
