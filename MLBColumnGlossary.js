...
var MLB_COLUMN_GLOSSARY = {
  ...
  'season_pa': 'Season plate appearances (sample size for rates).',
  'season_ab': 'Season at-bats.',
  'low_sample_pa': 'LOW when season PA is below STREAK_MIN_PA (or HITS_V3_MIN_PA on the v3 card). Pick gate uses the same floor on Streak.',
